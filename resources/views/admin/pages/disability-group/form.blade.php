                           ...
                           <div class="box-body">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{ route('disability-group.store') }}">
                                        @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <fieldset class="form-group">
                                                    <label>प्रकार</label>
                                                    <input name="type" class="form-control" id="basicInput" type="text" value="severity_of_disability" readonly>
                                                 @if($errors->any())
                                                    <div style="color:red !important">
                                                        {{ $errors->first('type') }}
                                                    </div>
                                            ...
                                            <div class="col-lg-6">
                                             ...
                                             <div class="col-lg-6">
                                                <fieldset class="form-group">
                                                    <label>रंग</label>
                                                    <input name="color" class="form-control" id="basicInput"  value="{{ old('color') }}" type="color">
                                                     @if($errors->any())
                                                    <div style="color:red !important">
                                                        {{ $errors->first('color') }}
                                                    </div>
